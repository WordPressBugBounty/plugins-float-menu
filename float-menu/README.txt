...
* Added: Custom border radius for each menu item’s icon and label
* Improved: Admin UI for better usability
* Fixed: Menu position issue on mobile devices

= 7.0.7 =
* Fixed: minor issue with settings

= 7.0.6 =
* Added: RTL support

= 7.0.5 =
* Fixed: Minor bug in Maker.php class
